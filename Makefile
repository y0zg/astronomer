...
# Airflow versions
AIRFLOW_VERSIONS := 1.10.3

# Vendor components
VENDOR_COMPONENTS := alertmanager cadvisor curator elasticsearch elasticsearch-exporter fluentd grafana kibana kube-replicator kube-state nginx nginx-es pgbouncer pgbouncer-exporter prisma prometheus redis registry statsd-exporter kube-eagle
